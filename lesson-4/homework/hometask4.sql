...
order by Price desc
select EmployeeID,coalesce (FirstName,LastName) as EmployeeName, DepartmentName, Salary, HireDate, Age,Email, Country from Employees
...
select EmployeeID, FirstName+' '+LastName as Fullname, DepartmentName, Salary, HireDate, Age,Email, Country from Employees
